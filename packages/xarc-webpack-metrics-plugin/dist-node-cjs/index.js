...
exports.WebpackMetricsPlugin = void 0;
class WebpackMetricsPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.compilation.tap('WebpackMetricsPlugin', (compilation) => {
            // Track modules that are being built (cache misses)
            compilation.hooks.buildModule.tap('WebpackMetricsPlugin', (module) => {
            ...
            compilation.hooks.succeedModule.tap('WebpackMetricsPlugin', (module) => {
                const moduleId = module.identifier();
            ...
            compilation.hooks.stillValidModule.tap('WebpackMetricsPlugin', (module) => {
                this.cacheHits++;
            });
        });
        compiler.hooks.done.tap('WebpackMetricsPlugin', (stats) => {
            ...
            if (totalModules > 0) {
                ...
                console.log(`\n💾 [CACHE] Performance:`);
                console.log(`   Cache Type: ${compiler.options.cache ? compiler.options.cache.type : 'none'}`);
            ...
            if (moduleTimings.length > 0) {
                ...
                moduleTimings.forEach((timing, index) => {
                    const name = timing.module.userRequest || timing.module.identifier();
...
exports.WebpackMetricsPlugin = WebpackMetricsPlugin;
