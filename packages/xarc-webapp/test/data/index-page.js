...
var _template = require("@xarc/jsx-renderer");
...
const RenderSubApps = (props, context) => {
  ...
  return (
    subApps &&
    subApps.length > 0 &&
    (0, _template.createElement)(
      "div",
      null,
      ...subApps.map((info, ix) => {
        const { subapp, options } = info;
        const elementId = props.inline
          ? undefined
          : `subapp-${subapp.name}-${ix}`;
        return (0, _template.createElement)(
          _template.Require,
          Object.assign(
            {
              _concurrent: true,
...
const Template = (0, _template.createElement)(
  _template.IndexPage,
  {
    DOCTYPE: "html",
  },
  ...
  (0, _template.createElement)(
    ...
    (0, _template.createElement)(
      ...
      (0, _template.createElement)(
        "noscript",
        null,
        (0, _template.createElement)("h4", null, "JavaScript is Disabled"),
        (0, _template.createElement)(
          "p",
          null,
      ...
      (0, _template.createElement)(RenderSubApps, null),
      (0, _template.createElement)(_template.Require, {
