...
This is a feature package that instructs [Electrode](https://github.com/electrode-io/electrode) to install critical CSS.
...
```sh
npm install electrode-archetype-opt-critical-css
```
