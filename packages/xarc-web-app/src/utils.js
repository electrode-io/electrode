...
import optionalRequireModule from "optinal-require";
const optionalRequire = optionalRequireModule(require);
import getDevProxy from "@xarc/app-dev/config/get-dev-proxy";
