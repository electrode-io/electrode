# Electrode Archetype Option Sinon

This is a feature package that instructs [Electrode](https://github.com/electrode-io/electrode) to install Sinon.
...
```sh
npm install electrode-archetype-opt-sinon
```
