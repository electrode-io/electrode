...
This is a feature package that instructs [Electrode](https://github.com/electrode-io/electrode) to install TypeScript.
...
```sh
npm install electrode-archetype-opt-typescript
```
