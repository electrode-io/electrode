...
const tasks = {
  ...
  "archetype:check": ["archetype:test-dev-pkg", "clean-test-init", "archetype:test-init-pkg", "clean-test-init"],
  ...
  "lint-react-src": mkCmd(`eslint --ext .js,.jsx`,
    `-c ${archetype.devPath}/config/eslint/.eslintrc-react src --color`),
  "lint-react-test": mkCmd(`eslint --ext .js,.jsx`, 
  ...
  "server-test": mkCmd(`webpack-dev-server --port 3001`,
  ...
  "test-frontend-dev-watch": mkCmd(`karma start ${archetype.devPath}/config/karma/karma.conf.watch.js`, 
