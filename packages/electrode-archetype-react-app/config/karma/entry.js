...
// Use webpack to infer and `require` tests automatically except for any
// spec tests living in `test/server`
var testsReq = require.context("test", true, /^((?!server).)*\.spec.jsx?$/);
