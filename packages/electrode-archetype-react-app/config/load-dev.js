...
function checkTopDevArchetype(devArchName) {
  ...
  if (topPkg.name === devArchName) {
    // In case electrode-archetype-react-app is being used for test/dev in the -dev archetype
    // resolve config/archetype in electrode-archetype-react-app-dev's own dir
