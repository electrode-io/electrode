...
```
npm install kununu-electrode-react-webapp --save
```
...
const reactWebapp = server.register({
  register: require("kununu-electrode-react-webapp"),
  options: {
...
```js
{
  ...
  htmlFile: "node_modules/kununu-electrode-react-webapp/lib/index.html",
  devServer: {
    host: "127.0.0.1",
    port: "2992"
  },
...
[npm-image]: https://badge.fury.io/js/kununu-electrode-react-webapp.svg
[npm-url]: https://npmjs.org/package/kununu-electrode-react-webapp
[daviddm-image]: https://david-dm.org/electrode-io/electrode/status.svg?path=packages/kununu-electrode-react-webapp
[daviddm-url]: https://david-dm.org/electrode-io/electrode?path=packages/kununu-electrode-react-webapp
[daviddm-dev-image]:https://david-dm.org/electrode-io/electrode/dev-status.svg?path=packages/kununu-electrode-react-webapp
[daviddm-dev-url]:https://david-dm.org/electrode-io/electrode?path=packages/kununu-electrode-react-webapp?type-dev
[npm-downloads-image]:https://img.shields.io/npm/dm/kununu-electrode-react-webapp.svg
[npm-downloads-url]:https://www.npmjs.com/package/kununu-electrode-react-webapp
