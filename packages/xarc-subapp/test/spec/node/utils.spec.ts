...
describe("Util tests", () => {
    ...
    it("test urLJoin", () => {
        ...
        expect(util.urlJoin("http://www.google.com", "cow", "bunga")).eq("http://www.google.com/cow/bunga");
        expect(util.urlJoin("http://www.google.com", "cow", "?bunga=true")).eq("http://www.google.com/cow?bunga=true");
        expect(util.urlJoin("http://www.google.com", "cow", "&bunga=true")).eq("http://www.google.com/cow?bunga=true");
        expect(util.urlJoin("http://www.google.com", "cow", "&bunga=true", "mango")).eq("http://www.google.com/cow?bunga=true&mango");
        expect(util.urlJoin("http://www.google.com", "cow", "&bunga=true", "mango=1")).eq("http://www.google.com/cow?bunga=true&mango=1");
        expect(util.urlJoin("http://www.google.com/hockey")).eq("http://www.google.com/hockey");
        expect(util.urlJoin("http://www.google.com/hockey", "mango")).eq("http://www.google.com/hockey/mango");
        expect(util.urlJoin("http://www.google.com?fishing=true", "cow", "?bunga=true")).eq("http://www.google.com/cow?fishing=true&bunga=true");
    });
