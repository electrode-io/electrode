...
module.exports = class extends Generator {
  ...
  writing() {
    ...
    project: {
      this.fs.copyTpl(this.templatePath("packages/component/babelrc"), this.destinationPath(".babelrc"));
      this.fs.copyTpl(this.templatePath("packages/component/gitignore"), this.destinationPath(".gitignore"));
      this.fs.copyTpl(this.templatePath("packages/component/npmignore"), this.destinationPath(".npmignore"));
      this.fs.copyTpl(this.templatePath("packages/component/editorconfig"), this.destinationPath(".editorconfig"));
      this.fs.copyTpl(this.templatePath("packages/component/_xclap.js"), this.destinationPath("xclap.js"));
      this.fs.copyTpl(this.templatePath("packages/component/_package.json"), this.destinationPath("package.json"));
      this.fs.copyTpl(this.templatePath("packages/component/_readme.md"), this.destinationPath("README.md"));
