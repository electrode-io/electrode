# Electrode Archetype Option Preact

This is a feature package that instructs [Electrode](https://github.com/electrode-io/electrode) to install Preact.
...
```sh
npm install electrode-archetype-opt-preact
```
