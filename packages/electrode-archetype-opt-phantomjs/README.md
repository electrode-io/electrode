...
This is a feature package that instructs [Electrode](https://github.com/electrode-io/electrode) to install phantomjs.
...
```sh
npm install electrode-archetype-opt-phantomjs
```
