# Electrode Archetype Option PWA

This is a feature package that instructs [Electrode](https://github.com/electrode-io/electrode) to install Progressive WebApp and service worker.
...
```sh
npm install electrode-archetype-opt-pwa
```
