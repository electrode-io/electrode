...
import {
    recoilFeature, useRecoilState,
    useRecoilValue, useSetRecoilState, selector, atom
...
const RecoilTodoApp = (props) => {
    ...
    return (
        ...
        <AppContext.Consumer>
            {({ isSsr, ssr }) => {
                return <div style={{ backgroundColor: "cyan", padding: 20 }}><TodoList {...props} /></div>
            }}
        </AppContext.Consumer>
    ...
    wantFeatures: [
        recoilFeature({
            ...
            prepare: async initialState => {
                ...
                return { atoms: [{ key: "todoListState", value: todoListState }, { key: "todoListFilterState", value: todoListFilterState }] };
            }
        })
