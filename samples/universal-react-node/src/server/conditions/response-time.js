...
module.exports = {
  detector: (_opts) => {
    const longResponseThreshold = _opts.longResponseThreshold || DEFAULT_LONG_RESPONSE_THRESHOLD_MS;
    const longResponseAmount = _opts.longResponseAmount || DEFAULT_LONG_RESPONSE_AMOUNT;
    const disableExpiryMins = _opts.disableExpiryMins || DEFAULT_DISABLE_EXPIRY_MINS;
